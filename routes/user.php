...
Route::prefix('user')->group(function () {//prefix дает возможность сделать приписку к адресной строке
     ...
     Route::post('posts', [PostController::class, 'store'])->name('user.posts.store'); // если правильно понял, что для храниения отправленной формы
